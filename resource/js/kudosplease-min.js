KudosPlease=(function(){
    var a=document.documentElement.classList,p=!!a,
    e=function(r,q){return p?function(s,t){
        if(t!=""){return s.classList[r](t)}}:q},
        g=e("add",function(s,r){r=r.split(",");
    ...
    if(s.className.indexOf(r[q])==-1){
        ...
        o=e("remove",function(s,r){
            ...
            for(var q=0;q<r.length;q++){
                ...
                d=e("contains",function(u,t){var s=u.className.split(" "),
                q=false;for(var r=0;r<s.length;r++){if(s[r]==t){q=true}}return q}),
                h=function(q,r,s){if(s.status!=undefined){
                    if(q.getAttribute("data-status")!=undefined){
                        o(q,s.status[q.getAttribute("data-status")])}
                        g(q,s.status[r]);q.setAttribute("data-status",r)}},
                        n=function(q,s,r){g(q,"finish");h(q,"gamma",r);
                        s=s||false;amount=l(parseInt(q.getAttribute("data-id"),10),r);
                        if(s){++amount;b(q,"POST",r)}},j=function(r,q,t){var s=-1;
                            if(!d(q,"finish")){g(q,"active");
                            s=setTimeout(function(){o(q,"active");
                            n(q,true,t)},t.duration);
